...
{
    // DCNT_MODE0 : tiled video mode, so we're using sprites instead of drawing directly to the screen buffer
    // DCNT_BG0 : enables the 0th background
    // DCNT_OBJ : tells our program to use sprites
    // DCNT_OBJ_1D : our sprites are stored in a 1-dimensional array; Grit handles this for us.
